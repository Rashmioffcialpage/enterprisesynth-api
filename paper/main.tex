...
Our contributions, scoped to what is actually implemented and measured (Section~8 gives the full
...
\begin{itemize}
    ...
    implemented in the current system; Section~8's ablation study is scoped to the four stages
    that actually exist.
...
$\rightarrow$ \{SFT Dataset, Evaluation Dataset\}
\end{center}
...
from the real spec: there would be nothing to hallucinate. Ablation A4 (Section~8.4) is a first,
