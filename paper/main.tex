...
\begin{center}
\begin{tabular}{llll}
\textbf{API} & \textbf{Valid judged plausible} & \textbf{Corruption still structurally valid} & \textbf{...caught by Haiku} \\
...
\texttt{PUT /orgs/\{org\}/actions/secrets/\{secret\_name\}/repositories} (description:
