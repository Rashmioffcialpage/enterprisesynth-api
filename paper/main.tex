...
\title{EnterpriseSynth: Agentic SFT and Eval Data from API Schemas Without Live Execution}
...
% TODO next sections: Methodology (three pillars per DESIGN_DOC.md \S4), Dataset (\S5),
% Training \& Eval (\S6), Results, Discussion, Limitations, Conclusion.
