...
object definitions), Authentication Extraction Accuracy (API keys, OAuth, JWT, Basic). Results:
to be measured for all three APIs above once Stage 1 is implemented.
...
(relevance/realism/enterprise-usefulness, 1--5 scale). Results: to be measured.
